...
const checkPassword = require("./editData");
const updatePassword = require("./register/updatePassword");

const userRegister = (userRequest, role, res) =>
  register(userRequest, role, res);
const userPasswordChange = (userRequest, res) =>
  updatePassword(userRequest, res);

const userLogin = (userRequest, role, res) => login(userRequest, role, res);

const userPasswordCheck = (userRequest, role, res) =>
  checkPassword(userRequest, role, res);
